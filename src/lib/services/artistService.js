 ...
 * Used for replay functionality from trash
 * @param {string} songId - The song ID to load
 * @param {string} artistUrlKey - Artist document ID
 * @returns {Promise<Object>} Song data with artistData and queueInfo
 */
